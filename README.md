 ...
 * Если к посту прикреплено много картинок, то показываются только несколько первых и кнопка «показать остальные»;
 * Слишком длинные посты и комментарии сворачиваются под кнопку «more...»;
 * Пока всё.
